            ...
            <div class="well">
                ...
                <div class="row education-row">
                    <div class="first-batch">
                        <div class="col-md-6">
                            <label>School</label>
                            <input type="text" class="form-control" aria-label="school" placeholder="">
                        </div>
                    ...
                    <div class="second-batch">
                        <div class="col-md-6">
                            <label>Degree</label>
                            <input type="text" class="form-control" aria-label="degree" placeholder="">
                        </div>

                        <div class="col-md-6">
                            <label>Studying period</label>
                            <input type="text" class="form-control" aria-label="studying period" placeholder="">
                        </div>
                    </div>
                </div>
