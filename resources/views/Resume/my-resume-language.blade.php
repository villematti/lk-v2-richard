            ...
            <div class="well">
                ...
                <div class="languages">
                    <div class="lingwahe">
                        ...
                        <input type="text" class="form-control" aria-label="language" placeholder="">
                    </div>
                ...
                <div class="row btn-row">
                    <div class="col-md-6">
                        <button type="submit" class="btn btn-md btn-success pull-left btn-block" id="educ-btn">Add more languages</button>
                    </div>
                </div>
