    ...
    <div class="row">
        <div class="col-md-8 col-md-offset-2">
            <div class="well">
                <table class="table"> 
                    <caption> 
                        <span class="sent-jb-appl">Sent Job Applications</span> 
                        <span class="sent-jb-appl-num">32 sent job applications</span>
                    </caption> 
                    ...
                    <tbody> 
                        <tr> 
                            <td class="col-md-4"><span class="categ-job">Restaurant Workers</span><br><span class="loc-snt">Tampere, Finland</span></td> 
                            <td class="col-md-3"><span class="exp-date">14 August 2016</span></td> 
                            <td class="col-md-3 btn-view"><button class="btn btn-success btn-block">View</button></td> 
