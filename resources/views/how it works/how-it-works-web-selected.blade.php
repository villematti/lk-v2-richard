...
<div class="row web-selected-row">
	<div class="container">
		<!--lokaldo web photo-->
		<div class="col-md-7">
			<img src="img/How it works/Safari.png" alt="Lokaldo web photo" class="img-responsive pull-left">
		</div>
		...
		<div class="col-md-5">
			...
			<p>You can now receive all of the video job applications directly in the same place. You can easily sort the candidates in different folders and even message them directly in our web-and mobile app.</p>

			<!--Ordered list-->
			<ol>
				<li> <p>Log in with Facebook.</p></li>
				<li><p>Post a Job.</p></li>
				<li><p>Receive all the video applications in Lokaldo.</p></li>
				<li><p>Select the most suitable candidate.</p></li>
			</ol>
		</div><!-- .col-md-5-->
	</div><!-- .container-->
</div><!-- /.row .web-selected-row-->
...
<div class="row got-questions-row">
	<div class="container">
		...
		<p>Contact us at <a href="" id="L-mail"><span class="lokaldo-email">info@lokaldo.com </span></a> and ask more questions.</p>
	</div><!-- /.container-->
